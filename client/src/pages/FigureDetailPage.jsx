  ...
  return (
    <AppShell>
      <main className="relative pb-24">
        ...
        {/* Figurines visuellement proches — DINOv2 neighbours; self-hides when
         *  photo search is off or the piece isn't on the index yet. */}
 ...
 */
function SimilarFiguresSection({ figureId, nsfwPref, t }) {
    ...
    <section className="max-w-7xl mx-auto px-6 mt-16">
      <header className="text-center mb-8">
        <p className="micro inline-flex items-center gap-2.5">
          ...
          <span aria-hidden className="ja not-italic text-[var(--color-or)]">似</span>
        </p>
