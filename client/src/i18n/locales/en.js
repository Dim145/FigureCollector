...
export default {
  ...
  "admin.tasks.body": "The 3D-compute (gsplat) job history: live state, which worker took each one, execution time and result. Retry a failure, force a stuck task to failed, or purge a finished entry. 360° (turntable) videos aren't shown here.",
  "admin.tasks.empty.title": "No tasks",
  "admin.tasks.empty.body": "3D-compute (gsplat) jobs show up here once a figurine is scanned in 3D.",
