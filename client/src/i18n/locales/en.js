...
export default {
  ...
  "admin.tasks.result.k.processed": "{n} figure(s) processed",
  "admin.tasks.result.k.updated": "{n} price(s) updated",
  "admin.tasks.result.k.filled": "{n} series matched",
  "admin.tasks.result.k.purged": "{n} scan(s) purged",
  "admin.tasks.result.k.release_today": "{n} release(s) today",
  "admin.tasks.result.k.release_j7": "{n} release(s) J-7",
  "admin.tasks.result.k.delivery_today": "{n} delivery(ies) today",
  "admin.tasks.result.k.delivery_overdue": "{n} overdue delivery(ies)",
