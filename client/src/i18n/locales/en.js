...
export default {
  ...
  "import.subtitle": "Paste your orzgk list's public share link (or product links) and pick which figures to add to your wishlist — up to 10 per batch.",
  ...
  "import.paste_hint": "Make your list public on orzgk (Share → Public → copy link), then paste it — the server fetches it, following pagination. Or paste product links, one per line. Fallback: paste the page HTML of a private list.",
  ...
  "import.back": "Back",
  "import.commit": "Import {n} figure(s)",
  ...
  "import.err.no_source": "Paste an orzgk wishlist link, product links, or the page HTML.",
